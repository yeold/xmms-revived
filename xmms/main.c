...
GtkItemFactoryEntry mainwin_options_menu_entries[] = {
    {N_("/Preferences"), "<control>P", (GtkItemFactoryCallback)mainwin_options_menu_callback, MAINWIN_OPT_PREFS,
     "<Item>"},
    ...
    {N_("/No Playlist Advance"), "<control>N", (GtkItemFactoryCallback)mainwin_options_menu_callback, MAINWIN_OPT_NPA,
     "<ToggleItem>"},
    {N_("/-"), NULL, NULL, 0, "<Separator>"},
    {N_("/Time Elapsed"), "<control>E", (GtkItemFactoryCallback)mainwin_options_menu_callback, MAINWIN_OPT_TELAPSED,
     "<RadioItem>"},
    {N_("/Time Remaining"), "<control>R", (GtkItemFactoryCallback)mainwin_options_menu_callback, MAINWIN_OPT_TREMAINING,
     "/Time Elapsed"},
    {N_("/Time Display (MMM:SS)"), "<shift><control>L", (GtkItemFactoryCallback)mainwin_options_menu_callback,
     MAINWIN_OPT_TDISPLAY, "<ToggleItem>"},
    {N_("/-"), NULL, NULL, 0, "<Separator>"},
    {N_("/Always On Top"), "<control>A", (GtkItemFactoryCallback)mainwin_options_menu_callback, MAINWIN_OPT_ALWAYS,
     "<ToggleItem>"},
    {N_("/Show on all desktops"), "<control>S", (GtkItemFactoryCallback)mainwin_options_menu_callback,
     MAINWIN_OPT_STICKY, "<ToggleItem>"},
    {N_("/WindowShade Mode"), "<control>W", (GtkItemFactoryCallback)mainwin_options_menu_callback, MAINWIN_OPT_WS,
     "<ToggleItem>"},
    {N_("/Playlist WindowShade Mode"), "<control><shift>W", (GtkItemFactoryCallback)mainwin_options_menu_callback,
     MAINWIN_OPT_PWS, "<ToggleItem>"},
    {N_("/Equalizer WindowShade Mode"), "<control><alt>W", (GtkItemFactoryCallback)mainwin_options_menu_callback,
     MAINWIN_OPT_EQWS, "<ToggleItem>"},
    {N_("/DoubleSize"), "<control>D", (GtkItemFactoryCallback)mainwin_options_menu_callback, MAINWIN_OPT_DOUBLESIZE,
     "<ToggleItem>"},
    {N_("/Easy Move"), "<control>E", (GtkItemFactoryCallback)mainwin_options_menu_callback, MAINWIN_OPT_EASY_MOVE,
     "<ToggleItem>"},
};
...
GtkItemFactoryEntry mainwin_songname_menu_entries[] = {
    {N_("/File Info"), NULL, (GtkItemFactoryCallback)mainwin_songname_menu_callback, MAINWIN_SONGNAME_FILEINFO,
     "<Item>"},
    {N_("/Jump To File"), "J", (GtkItemFactoryCallback)mainwin_songname_menu_callback, MAINWIN_SONGNAME_JTF, "<Item>"},
    {N_("/Jump To Time"), "<control>J", (GtkItemFactoryCallback)mainwin_songname_menu_callback, MAINWIN_SONGNAME_JTT,
     "<Item>"},
    {N_("/Autoscroll Song Name"), NULL, (GtkItemFactoryCallback)mainwin_songname_menu_callback, MAINWIN_SONGNAME_SCROLL,
     "<ToggleItem>"},
};
...
GtkItemFactoryEntry mainwin_vis_menu_entries[] = {
    ...
    {N_("/Visualization Mode/Analyzer"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_ANALYZER,
     "<RadioItem>"},
    {N_("/Visualization Mode/Scope"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_SCOPE,
     "/Visualization Mode/Analyzer"},
    {N_("/Visualization Mode/Off"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_OFF,
     "/Visualization Mode/Analyzer"},
    {N_("/Analyzer Mode"), NULL, NULL, 0, "<Branch>"},
    {N_("/Analyzer Mode/Normal"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_ANALYZER_NORMAL,
     "<RadioItem>"},
    {N_("/Analyzer Mode/Fire"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_ANALYZER_FIRE,
     "/Analyzer Mode/Normal"},
    {N_("/Analyzer Mode/Vertical Lines"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_ANALYZER_VLINES, "/Analyzer Mode/Normal"},
    {N_("/Analyzer Mode/-"), NULL, NULL, 0, "<Separator>"},
    {N_("/Analyzer Mode/Lines"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_ANALYZER_LINES,
     "<RadioItem>"},
    {N_("/Analyzer Mode/Bars"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_ANALYZER_BARS,
     "/Analyzer Mode/Lines"},
    {N_("/Analyzer Mode/-"), NULL, NULL, 0, "<Separator>"},
    {N_("/Analyzer Mode/Peaks"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_ANALYZER_PEAKS,
     "<ToggleItem>"},
    {N_("/Scope Mode"), NULL, NULL, 0, "<Branch>"},
    {N_("/Scope Mode/Dot Scope"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_SCOPE_DOT,
     "<RadioItem>"},
    {N_("/Scope Mode/Line Scope"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_SCOPE_LINE,
     "/Scope Mode/Dot Scope"},
    {N_("/Scope Mode/Solid Scope"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_SCOPE_SOLID,
     "/Scope Mode/Dot Scope"},
    {N_("/WindowShade VU Mode"), NULL, NULL, 0, "<Branch>"},
    {N_("/WindowShade VU Mode/Normal"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_VU_NORMAL,
     "<RadioItem>"},
    {N_("/WindowShade VU Mode/Smooth"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_VU_SMOOTH,
     "/WindowShade VU Mode/Normal"},
    {N_("/Refresh Rate"), NULL, NULL, 0, "<Branch>"},
    {N_("/Refresh Rate/Full (~50 fps)"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_REFRESH_FULL, "<RadioItem>"},
    {N_("/Refresh Rate/Half (~25 fps)"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_REFRESH_HALF, "/Refresh Rate/Full (~50 fps)"},
    {N_("/Refresh Rate/Quarter (~13 fps)"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_REFRESH_QUARTER, "/Refresh Rate/Full (~50 fps)"},
    {N_("/Refresh Rate/Eighth (~6 fps)"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_REFRESH_EIGHTH, "/Refresh Rate/Full (~50 fps)"},
    {N_("/Analyzer Falloff"), NULL, NULL, 0, "<Branch>"},
    {N_("/Analyzer Falloff/Slowest"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_AFALLOFF_SLOWEST, "<RadioItem>"},
    {N_("/Analyzer Falloff/Slow"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_AFALLOFF_SLOW,
     "/Analyzer Falloff/Slowest"},
    {N_("/Analyzer Falloff/Medium"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_AFALLOFF_MEDIUM, "/Analyzer Falloff/Slowest"},
    {N_("/Analyzer Falloff/Fast"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_AFALLOFF_FAST,
     "/Analyzer Falloff/Slowest"},
    {N_("/Analyzer Falloff/Fastest"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_AFALLOFF_FASTEST, "/Analyzer Falloff/Slowest"},
    {N_("/Peaks Falloff"), NULL, NULL, 0, "<Branch>"},
    {N_("/Peaks Falloff/Slowest"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_PFALLOFF_SLOWEST, "<RadioItem>"},
    {N_("/Peaks Falloff/Slow"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_PFALLOFF_SLOW,
     "/Peaks Falloff/Slowest"},
    {N_("/Peaks Falloff/Medium"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_PFALLOFF_MEDIUM,
     "/Peaks Falloff/Slowest"},
    {N_("/Peaks Falloff/Fast"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_PFALLOFF_FAST,
     "/Peaks Falloff/Slowest"},
    {N_("/Peaks Falloff/Fastest"), NULL, (GtkItemFactoryCallback)mainwin_vis_menu_callback,
     MAINWIN_VIS_PFALLOFF_FASTEST, "/Peaks Falloff/Slowest"},
    {N_("/Visualization plugins"), "<control>V", (GtkItemFactoryCallback)mainwin_vis_menu_callback, MAINWIN_VIS_PLUGINS,
     "<Item>"}};

static gint mainwin_vis_menu_entries_num = sizeof(mainwin_vis_menu_entries) / sizeof(mainwin_vis_menu_entries[0]);
...
GtkItemFactoryEntry mainwin_general_menu_entries[] = {
    ...
    {N_("/Play Directory"), "<shift>L", (GtkItemFactoryCallback)mainwin_general_menu_callback,
     MAINWIN_GENERAL_PLAYDIRECTORY, "<Item>"},
    {N_("/Play Location"), "<control>L", (GtkItemFactoryCallback)mainwin_general_menu_callback,
     MAINWIN_GENERAL_PLAYLOCATION, "<Item>"},
    {N_("/View File Info"), "<control>3", (GtkItemFactoryCallback)mainwin_general_menu_callback,
     MAINWIN_GENERAL_FILEINFO, "<Item>"},
    {N_("/-"), NULL, NULL, 0, "<Separator>"},
    {N_("/Main Window"), "<alt>W", (GtkItemFactoryCallback)mainwin_general_menu_callback, MAINWIN_GENERAL_SHOWMWIN,
     "<ToggleItem>"},
    {N_("/Playlist Editor"), "<alt>E", (GtkItemFactoryCallback)mainwin_general_menu_callback, MAINWIN_GENERAL_SHOWPLWIN,
     "<ToggleItem>"},
    {N_("/Graphical EQ"), "<alt>G", (GtkItemFactoryCallback)mainwin_general_menu_callback, MAINWIN_GENERAL_SHOWEQWIN,
     "<ToggleItem>"},
    {N_("/-"), NULL, NULL, 0, "<Separator>"},
    {N_("/Options"), NULL, NULL, 0, "<Item>"},
    {N_("/Playback"), NULL, NULL, 0, "<Branch>"},
    {N_("/Playback/Previous"), "Z", (GtkItemFactoryCallback)mainwin_general_menu_callback, MAINWIN_GENERAL_PREV,
     "<Item>"},
    {N_("/Playback/Play"), "X", (GtkItemFactoryCallback)mainwin_general_menu_callback, MAINWIN_GENERAL_PLAY, "<Item>"},
    {N_("/Playback/Pause"), "C", (GtkItemFactoryCallback)mainwin_general_menu_callback, MAINWIN_GENERAL_PAUSE,
     "<Item>"},
    ...
    {N_("/Playback/Back 5 Seconds"), NULL, (GtkItemFactoryCallback)mainwin_general_menu_callback,
     MAINWIN_GENERAL_BACK5SEC, "<Item>"},
    {N_("/Playback/Fwd 5 Seconds"), NULL, (GtkItemFactoryCallback)mainwin_general_menu_callback,
     MAINWIN_GENERAL_FWD5SEC, "<Item>"},
    {N_("/Playback/Start of List"), "<control>Z", (GtkItemFactoryCallback)mainwin_general_menu_callback,
     MAINWIN_GENERAL_START, "<Item>"},
    {N_("/Playback/10 Tracks Back"), NULL, (GtkItemFactoryCallback)mainwin_general_menu_callback,
     MAINWIN_GENERAL_BACK10, "<Item>"},
    {N_("/Playback/10 Tracks Fwd"), NULL, (GtkItemFactoryCallback)mainwin_general_menu_callback, MAINWIN_GENERAL_FWD10,
     "<Item>"},
    {N_("/Playback/-"), NULL, NULL, 0, "<Separator>"},
    {N_("/Playback/Jump to Time"), "<control>J", (GtkItemFactoryCallback)mainwin_general_menu_callback,
     MAINWIN_GENERAL_JTT, "<Item>"},
    {N_("/Playback/Jump to File"), "J", (GtkItemFactoryCallback)mainwin_general_menu_callback, MAINWIN_GENERAL_JTF,
     "<Item>"},
    {N_("/Playback/Clear Queue"), "<shift>Q", (GtkItemFactoryCallback)mainwin_general_menu_callback,
...
void save_config(void)
{
  ...
  if (disabled_iplugins && (g_list_length(disabled_iplugins) > 0))
  {
    ...
    while (d_iplist != NULL)
    {
      ...
      char *fname = g_path_get_basename(((InputPlugin *)d_iplist->data)->filename);
      cfg.disabled_iplugins = g_strconcat(temp, ",", fname, NULL);
      g_free(temp);
      g_free(fname);
      d_iplist = d_iplist->next;
    }
...
enum
{
  MAINWIN_VIS_ACTIVE_MAINWIN,
  MAINWIN_VIS_ACTIVE_PLAYLISTWIN
};
...
void mainwin_menubtn_cb(void)
{
  ...
  util_item_factory_popup(mainwin_general_menu, x + 6 * (1 + cfg.doublesize), y + 14 * (1 + cfg.doublesize), 1,
                          GDK_CURRENT_TIME);
}
...
void draw_mainwin_titlebar(int focus)
{
  if (focus || !cfg.dim_titlebar)
    skin_draw_pixmap(mainwin_bg, mainwin_gc, SKIN_TITLEBAR, 27, 29 * cfg.player_shaded, 0, 0, 275, 14);
  else
    skin_draw_pixmap(mainwin_bg, mainwin_gc, SKIN_TITLEBAR, 27, (27 * cfg.player_shaded) + 15, 0, 0, 275, 14);
}
...
void draw_main_window(gboolean force)
{
  ...
  if (force)
  {
    skin_draw_pixmap(mainwin_bg, mainwin_gc, SKIN_MAIN, 0, 0, 0, 0, 275, cfg.player_shaded ? 14 : 116);
      ...
      while (wl)
      {
        ...
        if (w->redraw && w->visible)
        {
          if (cfg.doublesize)
          {
            ...
            img2 = create_dblsize_image(img);
            gdk_draw_image(mainwin_bg_dblsize, mainwin_gc, img2, 0, 0, w->x << 1, w->y << 1, w->width << 1,
                           w->height << 1);
            gdk_image_destroy(img2);
            gdk_image_destroy(img);
...
{
  return (
      inside_widget(x, y, mainwin_menubtn) || inside_widget(x, y, mainwin_minimize) ||
      inside_widget(x, y, mainwin_shade) || inside_widget(x, y, mainwin_close) || inside_widget(x, y, mainwin_rew) ||
      inside_widget(x, y, mainwin_play) || inside_widget(x, y, mainwin_pause) || inside_widget(x, y, mainwin_stop) ||
      inside_widget(x, y, mainwin_fwd) || inside_widget(x, y, mainwin_eject) || inside_widget(x, y, mainwin_shuffle) ||
      inside_widget(x, y, mainwin_repeat) || inside_widget(x, y, mainwin_pl) || inside_widget(x, y, mainwin_eq) ||
      ...
      inside_widget(x, y, mainwin_splay) || inside_widget(x, y, mainwin_spause) || inside_widget(x, y, mainwin_sstop) ||
      inside_widget(x, y, mainwin_sfwd) || inside_widget(x, y, mainwin_seject) || inside_widget(x, y, mainwin_svis) ||
...
void mainwin_press(GtkWidget *widget, GdkEventButton *event, gpointer callback_data)
{
  ...
  if (event->button == 1 && event->type == GDK_BUTTON_PRESS && !inside_sensitive_widgets(event->x, event->y) &&
  ...
  else if (event->button == 1 && event->type == GDK_2BUTTON_PRESS && inside_widget(event->x, event->y, mainwin_info))
  {
  ...
  if ((event->button == 1) && event->type != GDK_2BUTTON_PRESS &&
      (inside_widget(event->x, event->y, mainwin_vis) || inside_widget(event->x, event->y, mainwin_svis)))
  {
    cfg.vis_type++;
  ...
  if (event->button == 3)
  {
    ...
    {
      util_item_factory_popup(mainwin_songname_menu, event->x_root, event->y_root, 3, event->time);
      grab = FALSE;
    }
  ...
  if (event->button == 1)
  {
    if ((event->x > 35 && event->x < 100 && event->y > 25 && event->y < 40) ||
        inside_widget(event->x, event->y, mainwin_stime_min) || inside_widget(event->x, event->y, mainwin_stime_sec))
    {
  ...
  if (grab)
    gdk_pointer_grab(mainwin->window, FALSE, GDK_BUTTON_MOTION_MASK | GDK_BUTTON_RELEASE_MASK, NULL, NULL,
                     GDK_CURRENT_TIME);
}
...
void mainwin_jump_to_time(void)
{
  ...
  g_signal_connect(G_OBJECT(mainwin_jtt), "destroy", G_CALLBACK(gtk_widget_destroyed), &mainwin_jtt);
  g_signal_connect(G_OBJECT(mainwin_jtt), "key-press-event", G_CALLBACK(util_dialog_keypress_cb), NULL);
  ...
  g_signal_connect(G_OBJECT(time_entry), "activate", G_CALLBACK(mainwin_jump_to_time_cb), time_entry);
...
static void mainwin_jump_to_file_select_row_cb(GtkCList *widget, gint row, gint column, GdkEventButton *event,
                                               gpointer cb_data)
{
  ...
  while (playlist)
  {
    ...
    if (nw == 0 ||                           /* zero char key */
        ...
        (nw == 1 && strlen(words[0]) == 1 && /* one char key */
         ((title && (strchr(title, tolower(words[0][0])) || strchr(title, toupper(words[0][0])))) ||
...
static void mainwin_jump_to_file(void)
{
  ...
  g_signal_connect(G_OBJECT(clist), "select-row", G_CALLBACK(mainwin_jump_to_file_select_row_cb), queue);
  g_signal_connect(G_OBJECT(clist), "key-press-event", G_CALLBACK(mainwin_jump_to_file_keypress_cb), NULL);
  ...
  g_signal_connect(G_OBJECT(edit), "key-press-event", G_CALLBACK(mainwin_jump_to_file_entry_keypress_cb), clist);
  ...
  g_signal_connect(G_OBJECT(queue), "clicked", G_CALLBACK(mainwin_jump_to_file_queue_cb), edit_clist_qlist_and_queue);
  GTK_WIDGET_SET_FLAGS(jump, GTK_CAN_DEFAULT);
  gtk_widget_show(jump);
  gtk_widget_grab_default(jump);
  ...
  {
    gtk_clist_moveto(GTK_CLIST(clist), GPOINTER_TO_INT(GTK_CLIST(clist)->selection->data), 0, 0.5, 0.0);
    GTK_CLIST(clist)->focus_row = GPOINTER_TO_INT(GTK_CLIST(clist)->selection->data);
  }
}

static void mainwin_queue_manager_select_row_cb(GtkCList *widget, gint row, gint column, GdkEventButton *event,
                                                gpointer cb_data)
{
...
{
  GtkWidget *bigbox, *lbox, *vbox, *qscrollwin, *scrollwin, *qlist, *clist, *qsep, *sep, *bbox, *qbox, *queue, *cancel,
      *edit, *queue_label, *search_label, *hbox, *move_up, *move_down, *remove;
  char *title[2];
  /*
   * This little bugger is because I need all these widgets in some of
   * the signal handlers. It will be freed when the window
  ...
  g_signal_connect(G_OBJECT(qlist), "key-press-event", G_CALLBACK(mainwin_queue_manager_qlist_keypress_cb),
                   edit_clist_qlist_and_queue);
  g_signal_connect(G_OBJECT(qlist), "row-move", G_CALLBACK(mainwin_queue_manager_reorder), edit_clist_qlist_and_queue);
  ...
  gtk_clist_set_column_justification(GTK_CLIST(clist), 0, GTK_JUSTIFY_RIGHT);
  gtk_clist_set_selection_mode(GTK_CLIST(clist), GTK_SELECTION_BROWSE);
  g_signal_connect(G_OBJECT(clist), "select-row", G_CALLBACK(mainwin_queue_manager_select_row_cb),
                   edit_clist_qlist_and_queue);
  g_signal_connect(G_OBJECT(clist), "key-press-event", G_CALLBACK(mainwin_queue_manager_keypress_cb), qlist);
  hbox = gtk_hbox_new(FALSE, 3);
  gtk_box_pack_start(GTK_BOX(vbox), hbox, FALSE, FALSE, 3);
  gtk_widget_show(hbox);
  ...
  g_signal_connect(G_OBJECT(edit), "changed", G_CALLBACK(mainwin_queue_manager_queue_refresh), qlist);
  g_signal_connect(G_OBJECT(edit), "key-press-event", G_CALLBACK(mainwin_queue_manager_entry_keypress_cb),
                   edit_clist_qlist_and_queue);
  gtk_box_pack_start(GTK_BOX(hbox), edit, TRUE, TRUE, 3);
  gtk_widget_show(edit);
  ...
  cancel = gtk_button_new_with_label(_("Close"));
  gtk_box_pack_start(GTK_BOX(bbox), cancel, FALSE, FALSE, 0);
  g_signal_connect_swapped(G_OBJECT(cancel), "clicked", G_CALLBACK(gtk_widget_destroy), G_OBJECT(mainwin_qm));
  GTK_WIDGET_SET_FLAGS(cancel, GTK_CAN_DEFAULT);
  gtk_widget_show(cancel);
  gtk_widget_show(bbox);
...
void mainwin_show_dirbrowser(void)
{
  ...
  {
    mainwin_dir_browser = xmms_create_dir_browser(_("Select directory to add:"), cfg.filesel_path, GTK_SELECTION_SINGLE,
                                                  mainwin_add_dir_handler);
    g_signal_connect_swapped(G_OBJECT(mainwin_dir_browser), "destroy", G_CALLBACK(gtk_widget_destroyed),
                             &mainwin_dir_browser);
...
void mainwin_show_add_url_window(void)
{
  ...
  mainwin_url_window = util_create_add_url_window(_("Enter location to play:"), G_CALLBACK(mainwin_url_ok_clicked),
                                                  G_CALLBACK(mainwin_url_enqueue_clicked));
  gtk_window_set_transient_for(GTK_WINDOW(mainwin_url_window), GTK_WINDOW(mainwin));
  g_signal_connect_swapped(G_OBJECT(mainwin_url_window), "destroy", G_CALLBACK(gtk_widget_destroyed),
                           &mainwin_url_window);
...
void mainwin_position_motioncb(gint pos)
{
  ...
  time = (length * pos) / 219;
  buf = g_strdup_printf(_("SEEK TO: %d:%-2.2d/%d:%-2.2d (%d%%)"), time / 60, time % 60, length / 60, length % 60,
...
void mainwin_real_show(void)
{
  ...
  nullmask = NULL;
  gdk_window_set_hints(mainwin->window, 0, 0, PLAYER_WIDTH, PLAYER_HEIGHT, PLAYER_WIDTH, PLAYER_HEIGHT,
...
void mainwin_songname_menu_callback(gpointer cb_data, guint action, GtkWidget *w)
{
  ...
  case MAINWIN_SONGNAME_SCROLL:
    cfg.autoscroll =
        GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_songname_menu, "/Autoscroll Song Name"))->active;
...
void mainwin_options_menu_callback(gpointer cb_data, guint action, GtkWidget *w)
{
  ...
  case MAINWIN_OPT_TDISPLAY:
    cfg.timer_minutes_only =
        GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_options_menu, "/Time Display (MMM:SS)"))->active;
    break;
  case MAINWIN_OPT_ALWAYS:
    mainwin_menurow->mr_always_selected =
        GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_options_menu, "/Always On Top"))->active;
  ...
  case MAINWIN_OPT_WS:
    mainwin_set_shade_menu_cb(
        GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_options_menu, "/WindowShade Mode"))->active);
    break;
  case MAINWIN_OPT_PWS:
    playlistwin_set_shade_menu_cb(
        GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_options_menu, "/Playlist WindowShade Mode"))->active);
    break;
  case MAINWIN_OPT_EQWS:
    equalizerwin_set_shade_menu_cb(
        GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_options_menu, "/Equalizer WindowShade Mode"))->active);
    break;
  case MAINWIN_OPT_DOUBLESIZE:
    mainwin_menurow->mr_doublesize_selected =
        GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_options_menu, "/DoubleSize"))->active;
    draw_widget(mainwin_menurow);
...
void mainwin_vis_menu_callback(gpointer cb_data, guint action, GtkWidget *w)
{
  ...
  case MAINWIN_VIS_ANALYZER_PEAKS:
    cfg.analyzer_peaks =
        GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_vis_menu,
                                                        mainwin_vis_menu_entries[MAINWIN_VIS_MENU_ANALYZER_PEAKS].path))
            ->active;
    break;
...
void mainwin_general_menu_callback(gpointer cb_data, guint action, GtkWidget *w)
{
  ...
  case MAINWIN_GENERAL_FWD10:
    playlist_set_position((((get_playlist_position() + 10) < get_playlist_length()) ? (get_playlist_position() + 10)
...
#define CHECK_SET(menu, path, cfg)                                                                                     \
  gtk_check_menu_item_set_active(GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(menu, path)), cfg);
...
void create_popups(void)
{
  ...
  gtk_item_factory_create_items(mainwin_options_menu, mainwin_options_menu_entries_num, mainwin_options_menu_entries,
                                NULL);
  ...
  gtk_item_factory_create_items(mainwin_songname_menu, mainwin_songname_menu_entries_num, mainwin_songname_menu_entries,
                                NULL);
  ...
  gtk_check_menu_item_set_active(
      GTK_CHECK_MENU_ITEM(gtk_item_factory_get_widget(
          mainwin_vis_menu, mainwin_vis_menu_entries[MAINWIN_VIS_MENU_PFALLOFF + cfg.peaks_falloff].path)),
      TRUE);
  ...
  gtk_item_factory_create_items(mainwin_general_menu, mainwin_general_menu_entries_num, mainwin_general_menu_entries,
                                NULL);

  gtk_menu_item_set_submenu(GTK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_general_menu, "/Options")),
                            GTK_WIDGET(gtk_item_factory_get_widget(mainwin_options_menu, "")));
  gtk_menu_item_set_submenu(GTK_MENU_ITEM(gtk_item_factory_get_widget(mainwin_general_menu, "/Visualization")),
...
static void mainwin_create_widgets(void)
{
  ...
  mainwin_menubtn =
      create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 6, 3, 9, 9, 0, 0, 0, 9, mainwin_menubtn_cb, SKIN_TITLEBAR);
  mainwin_menubtn->pb_allow_draw = FALSE;
  mainwin_minimize = create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 244, 3, 9, 9, 9, 0, 9, 9,
                                    mainwin_minimize_cb, SKIN_TITLEBAR);
  mainwin_minimize->pb_allow_draw = FALSE;
  mainwin_shade = create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 254, 3, 9, 9, 0, cfg.player_shaded ? 27 : 18,
                                 9, cfg.player_shaded ? 27 : 18, mainwin_shade_toggle, SKIN_TITLEBAR);
  mainwin_shade->pb_allow_draw = FALSE;
  mainwin_close = create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 264, 3, 9, 9, 18, 0, 18, 9, mainwin_quit_cb,
                                 SKIN_TITLEBAR);
  mainwin_close->pb_allow_draw = FALSE;

  mainwin_rew =
      create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 16, 88, 23, 18, 0, 0, 0, 18, playlist_prev, SKIN_CBUTTONS);
  mainwin_play = create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 39, 88, 23, 18, 23, 0, 23, 18,
                                mainwin_play_pushed, SKIN_CBUTTONS);
  mainwin_pause =
      create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 62, 88, 23, 18, 46, 0, 46, 18, input_pause, SKIN_CBUTTONS);
  mainwin_stop = create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 85, 88, 23, 18, 69, 0, 69, 18,
                                mainwin_stop_pushed, SKIN_CBUTTONS);
  mainwin_fwd = create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 108, 88, 22, 18, 92, 0, 92, 18, playlist_next,
                               SKIN_CBUTTONS);
  mainwin_eject = create_pbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 136, 89, 22, 16, 114, 0, 114, 16,
  ...
  mainwin_shuffle = create_tbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 164, 89, 46, 15, 28, 0, 28, 15, 28, 30, 28,
                                   45, mainwin_shuffle_pushed, SKIN_SHUFREP);
  mainwin_repeat = create_tbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 210, 89, 28, 15, 0, 0, 0, 15, 0, 30, 0, 45,
                                  mainwin_repeat_pushed, SKIN_SHUFREP);

  mainwin_eq = create_tbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 219, 58, 23, 12, 0, 61, 46, 61, 0, 73, 46, 73,
                              equalizerwin_show, SKIN_SHUFREP);
  tbutton_set_toggled(mainwin_eq, cfg.equalizer_visible);
  mainwin_pl = create_tbutton(&mainwin_wlist, mainwin_bg, mainwin_gc, 242, 58, 23, 12, 23, 61, 69, 61, 23, 73, 69, 73,
  ...
  mainwin_menurow = create_menurow(&mainwin_wlist, mainwin_bg, mainwin_gc, 10, 22, 304, 0, 304, 44, mainwin_mr_change,
                                   mainwin_mr_release, SKIN_TITLEBAR);
  mainwin_menurow->mr_doublesize_selected = cfg.doublesize;
  mainwin_menurow->mr_always_selected = cfg.always_on_top;

  mainwin_volume =
      create_hslider(&mainwin_wlist, mainwin_bg, mainwin_gc, 107, 57, 68, 13, 15, 422, 0, 422, 14, 11, 15, 0, 0, 51,
                     mainwin_volume_framecb, mainwin_volume_motioncb, mainwin_volume_releasecb, SKIN_VOLUME);
  mainwin_balance =
      create_hslider(&mainwin_wlist, mainwin_bg, mainwin_gc, 177, 57, 38, 13, 15, 422, 0, 422, 14, 11, 15, 9, 0, 24,
                     mainwin_balance_framecb, mainwin_balance_motioncb, mainwin_balance_releasecb, SKIN_BALANCE);
  ...
  mainwin_position =
      create_hslider(&mainwin_wlist, mainwin_bg, mainwin_gc, 16, 72, 248, 10, 248, 0, 278, 0, 29, 10, 10, 0, 0, 219,
                     NULL, mainwin_position_motioncb, mainwin_position_releasecb, SKIN_POSBAR);
  hide_widget(mainwin_position);

  mainwin_sposition =
      create_hslider(&mainwin_wlist, mainwin_bg, mainwin_gc, 226, 4, 17, 7, 17, 36, 17, 36, 3, 7, 36, 0, 1, 13,
                     mainwin_spos_frame_cb, mainwin_spos_motion_cb, mainwin_spos_release_cb, SKIN_TITLEBAR);
  hide_widget(mainwin_sposition);
...
static void mainwin_create_gtk(void)
{
  ...
  g_signal_connect(G_OBJECT(mainwin), "button-press-event", G_CALLBACK(mainwin_press), NULL);
  g_signal_connect(G_OBJECT(mainwin), "button-release-event", G_CALLBACK(mainwin_release), NULL);
  g_signal_connect(G_OBJECT(mainwin), "motion-notify-event", G_CALLBACK(mainwin_motion), NULL);
  g_signal_connect(G_OBJECT(mainwin), "focus-in-event", G_CALLBACK(mainwin_focus_in), NULL);
  g_signal_connect(G_OBJECT(mainwin), "focus-out-event", G_CALLBACK(mainwin_focus_out), NULL);
  g_signal_connect(G_OBJECT(mainwin), "configure-event", G_CALLBACK(mainwin_configure), NULL);
  g_signal_connect(G_OBJECT(mainwin), "client-event", G_CALLBACK(mainwin_client_event), NULL);
  xmms_drag_dest_set(mainwin);
  g_signal_connect(G_OBJECT(mainwin), "drag-data-received", G_CALLBACK(mainwin_drag_data_received), NULL);
...
static void output_failed(void)
{
  ...
  if (!infobox)
  {
    ...
    g_signal_connect_swapped(G_OBJECT(infobox), "destroy", G_CALLBACK(gtk_widget_destroyed), &infobox);
  }
  else
...
gint idle_func(gpointer data)
{
  ...
  if (get_input_playing())
  {
    ...
    if (time == -1)
    {
      ...
      if (!cfg.pause_between_songs || g_timer_elapsed(pause_timer, NULL) >= cfg.pause_between_songs_time)
      {
        GDK_THREADS_ENTER();

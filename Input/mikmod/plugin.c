...
static void aboutbox()
{
  ...
  if (!about_window)
  {
    ...
    gtk_signal_connect_object(GTK_OBJECT(about_exit), "clicked", GTK_SIGNAL_FUNC(gtk_widget_destroy),
...
static void configure()
{
  ...
  if (!mikmod_conf_window)
  {
    ...
    gtk_signal_connect(GTK_OBJECT(mikmod_conf_window), "destroy", GTK_SIGNAL_FUNC(gtk_widget_destroyed),
                       &mikmod_conf_window);
...
InputPlugin mikmod_ip = {NULL,      NULL,     NULL, /* Description */
                         init,      aboutbox, configure, is_our_file, NULL,          play_file, stop,
                         mod_pause, seek,     NULL,      get_time,    NULL,          NULL,      NULL,
                         NULL,      NULL,     NULL,      NULL,        get_song_info, NULL, /* file_info_box */
                         NULL};

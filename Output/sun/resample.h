...
#define NOT_NATIVE_ENDIAN                                                                                              \
  ((IS_BIG_ENDIAN &&                                                                                                   \
    (output.format.sun == AUDIO_ENCODING_SLINEAR_LE || output.format.sun == AUDIO_ENCODING_ULINEAR_LE)) ||             \
   (!IS_BIG_ENDIAN &&                                                                                                  \
    (output.format.sun == AUDIO_ENCODING_SLINEAR_BE || output.format.sun == AUDIO_ENCODING_ULINEAR_BE)))

#define RESAMPLE_STEREO16(sample_type)                                                                                 \
  do                                                                                                                   \
  {                                                                                                                    \
